new Vue({
  ...
  computed: {
    ...
    areAllAccordionsOpen: function areAllAccordionsOpen() {var _this = this;
      return Object.keys(this.accordions).
      every(function (key) {return _this.accordions[key].isOpen;});
    },
  ...
  methods: {
    toggleAll: function toggleAll() {var _this2 = this;
